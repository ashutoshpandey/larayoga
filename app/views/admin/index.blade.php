...
<html lang="en">
                      ...
                      <!-- SERVER STATUS PANELS -->
                      	...
                      	<div class="col-md-4 col-sm-4 mb">
                      		<div class="white-panel pn">
								...
								<div class="row">
	                      		...
	                      		<div class="centered">
								    {{HTML::image(asset('/public/img/product.png'), '', array('width'=>"120"))}}
	                      		</div>
                      		</div>
                      	</div><!-- /col-md-4 -->
						...
						<div class="col-md-4 mb">
							...
							<div class="white-panel pn">
								...
								<p>{{HTML::image(asset("/public/img/ui-zac.jpg"), 'Avatar', array('class'=>'img-circle', 'style'=>'width:80'))}}</p>
								<p><b>Zac Snider</b></p>
								<div class="row">
									<div class="col-md-6">
  ...
  {{HTML::script(asset("/public/js/chart-master/Chart.js"))}}
  ...
  {{HTML::script(asset("/public/js/jquery.sparkline.js"))}}
  {{HTML::script(asset("/public/js/common-scripts.js"))}}

  {{HTML::script(asset("/public/js/sparkline-chart.js"))}}
  {{HTML::script(asset("/public/js/zabuto_calendar.js"))}}

  {{HTML::script(asset("/public/js/gritter/js/jquery.gritter.js"))}}
  {{HTML::script(asset("/public/js/gritter-conf.js"))}}
