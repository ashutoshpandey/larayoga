<aside>
    <div id="sidebar"  class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
            ...
            <p class="centered"><a href="profile.html">{{HTML::image(asset("/public/img/ui-sam.jpg"), 'Avatar', array('class'=>'img-circle', 'style'=>'width:60'))}}</a></p>
            ...
            <li class="sub-menu">
                ...
                <ul class="sub">
                    ...
                    <li><a  href="import-products">Import</a></li>
                </ul>
            </li>
