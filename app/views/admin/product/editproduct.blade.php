...
<head>
    ...
    {{HTML::style(asset("/public/css/product/edit.css"))}}
...
<div class="col-lg-9 main-chart">
    ...
    <form class="frmupdateproduct">
        ...
        <input type="text" name="specialprice" value="{{$product->specialprice}}"/>
        ...
        <label>&nbsp;</label>
        <button type="button" name="btnupdateproduct">Update Product</button>
    </form>
...
{{HTML::script(asset("/public/js/admin/editproduct.js"))}}
